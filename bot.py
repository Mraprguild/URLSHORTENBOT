...
class URLShortenerBot:
    ...
    def encode_url(self, url: str) -> str:
        """Encode URL for callback data (safe for Telegram's 64-byte limit)"""
        # Use base64 encoding to handle special characters and stay within size limits
    ...
    def decode_url(self, encoded_url: str) -> str:
        ...
        try:
            ...
            return encoded_url.replace('_', '/').replace('|', ':')
...
Contact support if you need assistance setting up monetization.
    ...
    async def process_url(self, update: Update, url: str):
        ...
        try:
            ...
            # Use base64 encoding for callback data to handle special characters
